...
public class CarGame extends JComponent implements ActionListener {
    ...
    public void paintComponent(Graphics g) {
        ...
        //hitbox
       //g.setColor(Color.BLACK);
       //g.drawRect(carBox.x - camX, carBox.y - camY, carBox.width, carBox.height);
       //g.setColor(Color.BLUE);
       //g.drawRect(carBoxBack.x - camX, carBoxBack.y - camY, carBoxBack.width, carBoxBack.height);
